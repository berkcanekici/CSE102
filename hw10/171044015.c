...
/*­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­                                                                          
                         Function Prototypes                              
­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­                                                                            */
void read_file(char *); // In this function, points and truths are calculated and stored in two different structures.
...
void read_file(char *filename)
{
    ...
    while (1)
    {
        ...
        if (1 == pg_count)
        { // This is a polygon. But it doesn't work correctly.
...
void calculations(points points_index, lines lines_index[100], char *filename)
{
    ...
    while (1)
    {
        ...
        if (3 < count && 1 == actions_flag)
        {
            ...
            char *token = strtok(line, " ");
            if (!strcmp("Distance", token) && p_count == 2)
            ...
            if (!strcmp("Distance", token) && 1 == p_count && 1 == l_count)
            ...
            if (!strcmp("Angle", token))
            { // The angle between the two lines is calculated.
                double x1, x2, y1, y2;
            ...
            if (!strcmp("Length", token) && 2 == l_count)
