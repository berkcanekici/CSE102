...
/*­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­
                          Function Prototypes
            ­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­­                                                                */
int *read_array(char *filename, int *heap);
Node *read_linkedlist(char *filename, int *size_list);
float *stats_array(int *pd);
float *stats_linkedlist(Node *gpfirst, int *size_list);
...
int main()
{
    ...
    int p2_size = 0;
    int *p = NULL; //2. part dinamik dizi
    Node *pnewnode = NULL;
    Wrong *my_arr = NULL;
