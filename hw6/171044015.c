    ...
    for (int i = 0; i < 10; ++i)
    {
        ...
        switch (direction)
        {
            ...
            case 5: // yukaridan sag asagiya left to right word placecement
                ...
                break;
            case 6: // yukaridan sol asagi left to right word placecement
                // this loop checks if the word to be placed overlaps the already placed words
                while (1)
                {
                    int k = 0;
                ...
                break;
            case 7: // asagidan sag yukari left to right word placecement
                // this loop checks if the word to be placed overlaps the already placed words
                while (1)
                {
                    int k = 0;
                ...
                break;
            case 8: // asagidan sol yukari left to right word placecement
                // this loop checks if the word to be placed overlaps the already placed words
                while (1)
                {
                    int k = 0;
