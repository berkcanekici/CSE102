...
int main() {
    ...
    if(select == 1 && second_select == 1) {
        amount *= 1;
        printf("You have %f TL\n", amount);
    }

    if (select == 1 && second_select == 2)
    {
        amount /= EURO;
        printf("You have %f EURO\n", amount);
    }
    if (select == 1 && second_select == 3)
    {
        amount /= DOLLAR;
        printf("You have %f DOLLAR\n", amount);
    }
    if (select == 2 && second_select == 1)
    {
        amount *= EURO;
        printf("You have %f TL\n", amount);
    }

    if (select == 2 && second_select == 2)
    {
        amount *= 1;
        printf("You have %f EURO\n", amount);
    }
    if (select == 2 && second_select == 3)
    {
        amount *= (EURO / DOLLAR);
        printf("You have %f DOLLAR\n", amount);
    }
    if (select == 3 && second_select == 1)
    {
        amount *= DOLLAR;
        printf("You have %f TL\n", amount);
    }

    if (select == 3 && second_select == 2)
    {
        amount *= (DOLLAR / EURO);
        printf("You have %f EURO", amount);
    }
    if (select == 3 && second_select == 3)
    {
        amount *= 1;
        printf("You have %f DOLLAR\n", amount);
    }
